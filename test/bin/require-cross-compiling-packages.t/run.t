...
dune-universe:
  ...
  $ opam show --just-file -fdepends ./a.opam
  dune, b
  $ opam show --just-file -fx-opam-monorepo-opam-repositories --raw ./a.opam
  file://$OPAM_MONOREPO_CWD/opam-repository, file://$OPAM_MONOREPO_CWD/opam-overlays
  $ opam show --just-file -fdepends ./a-with-mirage.opam
  dune, b
  $ opam show --just-file -fx-opam-monorepo-opam-repositories --raw ./a-with-mirage.opam
...
overlays the solver picks the dune port as expected:
  ...
  $ opam show --just-file -fdepends ./a.opam.locked | grep "\"b\""
  "b" {= "0.1+dune" & ?vendor}
...
version is higher (+mirage):
  ...
  $ opam show --just-file -fdepends ./a-with-mirage.opam.locked | grep "\"b\""
